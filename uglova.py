...
from app.deformation.calculators.DeformationCalculatorBetweenTwoFlatDefScan import DeformationCalculatorBetweenTwoFlatDefScan
...
scan1.filter_scan(filter_cls=ScanFilterDelimiter, delimiter=20)
scan2.filter_scan(filter_cls=ScanFilterDelimiter, delimiter=20)
print(scan1)
print(scan2)
